      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">
            This will only take a minute, and you can always change these details later
          </p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 mb-1">Unlimited Links</h3>
            <p className="text-sm text-gray-600">Add as many links as you want to your page</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">Customize your page with vibrant themes</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">Track clicks and engagement on your links</p>
          </div>
        </div>
      </div>
    </div>
