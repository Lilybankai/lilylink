...
const SocialIcon: React.FC<{ name: string; size: number; color?: string }> = ({ name, size, color = 'currentColor' }) => {
...
export const IconPicker: React.FC<IconPickerProps> = ({ selectedIcon, onSelect, onClose }) => {
  ...
  const { iconCategories, iconLibrary, getIconsByCategory, searchIcons } = require('@/lib/icons');
